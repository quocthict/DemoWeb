...
<div class="container" id="listing">
    ...
    <table class="table table-striped">
        ...
        <tbody>
        <c:forEach items="${listContactChild}" var="x">
            <tr>
                <td>${x.getId()}</td>
                ...
                <td>
                    <a href="/child/child_update?id=${x.getId()}" class="btn btn-default">Edit</a> &nbsp;
                    <a href="/child/child_delete?id=${x.getId()}" class="btn btn-default">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<div>
    <a href="child_add.jsp" class="btn btn-default">Create child</a>
</div>
